...
public class Game {
	...
	public boolean isPaused()	//Gibt an, ob das Spiel pausiert ist
	{
		return isPaused;
	}
	
	public Pacman getPacman()	//Gibt Pacman wieder
	{
		return pacman;
	}
	public int getScore()		//Gibt den Punktestand wieder
	{
		return score;
	}
	
	public int getRemainingLives()	//Gibt die übrigen Leben wieder
	{
		return remainingLives;
	}
	
	public int getLevel()			//Gibt das Level wieder
	{
		return level;
	}
	
	public static void resetLevel()	//Setzt Leven auf eins zurück
	{
		level = 1;
		Main.getAccounts().getUser().resetLevel();
	}
	
	public static void levelUp()	//Erhöt das Level um eins
	{
		level++;
		Main.getAccounts().getUser().increaseLevel();
	}
	
	private void checkWin()	//Testet, ob der Spieler alle Punkte konsumiert hat
	{
		if (pointsLeft == 0)
		{
			isGameOver = true;
	...
	private void updateScore() //updated den Punktestand
	{
	...
	{
		/*Spielt todes Ton ab und setzt Pacman zurück an seine Startposition, wenn er gegessen wird
		 * außerdem wird der Lebens Zähler verrignert*/
	...
	{
		/*Spielt sound ab, wenn pacman Geist isst
		 *erhöht Punktestand*/
